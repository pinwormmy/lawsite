                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        ...
                        <div class="post-navigation col-xs-12"">
                            <hr>
                            <a class="pull btn btn-theme cancel-btn" href="/video/list" accesskey="l">목 록(L)</a>
                            <c:if test="${member.id == post.writer || member.grade == 3}">
                                <a class="pull btn btn-theme cancel-btn" href="/video/deletePost?postNum=${post.postNum}" accesskey="t">삭 제(T)</a>
                                <a class="pull btn btn-theme cancel-btn" href="/video/modifyPost?postNum=${post.postNum}" accesskey="o">️수 정(O)</a>
                            </c:if>
                        </div>
                    </div>
                </div>
