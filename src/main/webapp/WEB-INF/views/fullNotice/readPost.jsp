                    ...
                    <div class="row">
                        ...
                        <div class="post-navigation col-xs-12"">
                            ...
                            <c:if test="${member.id == post.writer || member.grade == 3}">
                                <a class="pull-right basic-button-white" href="/fullNotice/deletePost?postNum=${post.postNum}">🗑️글 삭제</a>
...
function pageSettingAndLoadComment(commentPage) {
    fetch("/fullNotice/commentPageSetting", {
            method: 'POST',
            headers: {"Content-Type" : "application/json"},
            body: JSON.stringify({
...
function loadCommentFetch(pageDTO) {
    ...
    fetch("/fullNotice/showCommentList", {
        method: "POST",
        headers: {"Content-Type" : "application/json"},
