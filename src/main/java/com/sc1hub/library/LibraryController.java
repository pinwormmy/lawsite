...
import com.sc1hub.util.FileUtils;
...
public class LibraryController {
    ...
    public ResponseEntity<Resource> fileDown(@RequestParam("fileName") String fileName,
        ...
        //헤더에 파일명으로 첨부파일 추가
        headers.add("Content-Disposition", "attachment; filename=" + new String(Objects.requireNonNull(resourceName).getBytes(StandardCharsets.UTF_8),
