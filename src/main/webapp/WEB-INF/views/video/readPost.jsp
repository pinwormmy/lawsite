                ...
                <div class="col-lg-7">
                    ...
                    <div class="row">
                        ...
                        <div class="post-navigation col-xs-12"">
                            <a class="pull-left basic-button-white" href="/video/list">📝글 목록</a>
                            <c:if test="${member.id == post.writer || member.grade == 3}">
                                <a class="pull-right basic-button-white" href="/video/deletePost?postNum=${post.postNum}">🗑️글 삭제</a>
                                <a class="pull-right basic-button-white" href="/video/modifyPost?postNum=${post.postNum}">✏️글 수정</a>
                            </c:if>
                        </div>
                    </div>
                </div>
